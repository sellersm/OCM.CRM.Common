...
''------------------------------------------------------------------------------
'''' <summary>
'''' Represents the UI model for the 'CRMAnnualLetterScannerAddDataFormBARCODEELEMENTS' data form
'''' </summary>
'Partial Public Class [CRMAnnualLetterScannerAddDataFormBARCODEELEMENTSUIModel]
...
'    Private WithEvents _field2 As Global.Blackbaud.AppFx.UIModeling.Core.StringField
'    Private WithEvents _field3 As Global.Blackbaud.AppFx.UIModeling.Core.StringField
...
'        _field2 = New Global.Blackbaud.AppFx.UIModeling.Core.StringField
'        _field3 = New Global.Blackbaud.AppFx.UIModeling.Core.StringField
...
'        _field1.MaxLength = 100
'        Me.Fields.Add(_field1)
'        '
'        '_field2
'        '
'        _field2.Name = "FIELD2"
'        _field2.Caption = "Field 2"
'        _field2.MaxLength = 100
'        Me.Fields.Add(_field2)
'        '
'        '_field3
'        '
'        _field3.Name = "FIELD3"
'        _field3.Caption = "Field 3"
'        _field3.MaxLength = 100
'        Me.Fields.Add(_field3)
...
'    ''' Field 2
'    ''' </summary>
'    <System.ComponentModel.Description("Field 2")> _
'    <System.CodeDom.Compiler.GeneratedCodeAttribute("BBUIModelLibrary", "2.93.2034.0")> _
'    Public ReadOnly Property [FIELD2]() As Global.Blackbaud.AppFx.UIModeling.Core.StringField
'        Get
'            Return _field2
'        End Get
'    End Property
...
'    ''' Field 3
'    ''' </summary>
'    <System.ComponentModel.Description("Field 3")> _
'    <System.CodeDom.Compiler.GeneratedCodeAttribute("BBUIModelLibrary", "2.93.2034.0")> _
'    Public ReadOnly Property [FIELD3]() As Global.Blackbaud.AppFx.UIModeling.Core.StringField
'        Get
'            Return _field3
'        End Get
'    End Property
