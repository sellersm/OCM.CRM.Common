...
Public Class SponsorAppealLetterScannerAddDataFormUIModel
	...
	Private Sub BarCodeAddDataFormUIModel_Validate(ByVal sender As Object, ByVal e As Blackbaud.AppFx.UIModeling.Core.BeginValidateEventArgs) Handles Me.BeginValidate
		...
		Dim element As SponsorAppealLetterScannerAddDataFormBARCODEELEMENTSUIModel = New SponsorAppealLetterScannerAddDataFormBARCODEELEMENTSUIModel()
	...
	Private Sub ProcessBarCode()
		...
		Using conn As SqlClient.SqlConnection = Me.GetRequestContext().OpenAppDBConnection()
			...
			cmd.Connection = conn
			cmd.CommandText = "dbo.USR_USP_SPONSORAPPEAL_LETTERSCANNER"
