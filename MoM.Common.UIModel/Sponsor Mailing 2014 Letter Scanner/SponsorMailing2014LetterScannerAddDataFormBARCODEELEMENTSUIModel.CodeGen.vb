...
''' <summary>
''' Represents the UI model for the 'SponsorMailing2014LetterScannerAddDataFormBARCODEELEMENTS' data form
''' </summary>
Partial Public Class [SponsorMailing2014LetterScannerAddDataFormBARCODEELEMENTSUIModel]
