...
''' <summary>
''' Represents the UI model for the 'Sponsor Mailing 2014 letter scanner add data form' data form
''' </summary>
<Global.Blackbaud.AppFx.UIModeling.Core.DataFormUIModelMetadata(Global.Blackbaud.AppFx.UIModeling.Core.DataFormMode.Add, "90f6e17c-28cf-4ada-bcb5-0554b605f2b2", "e09beb61-3e7b-4e60-8f77-07b395eabbce", "Letterscanner")> _
Partial Public Class [SponsorMailing2014LetterScannerAddDataFormUIModel]
...
#End Region
	...
	Private WithEvents _barcodeelements As Global.Blackbaud.AppFx.UIModeling.Core.CollectionField(Of SponsorMailing2014LetterScannerAddDataFormBARCODEELEMENTSUIModel)
	...
	Public Sub New()
		...
		_barcodeelements = New Global.Blackbaud.AppFx.UIModeling.Core.CollectionField(Of SponsorMailing2014LetterScannerAddDataFormBARCODEELEMENTSUIModel)
		...
		MyBase.DataFormTemplateId = New Guid("90f6e17c-28cf-4ada-bcb5-0554b605f2b2")
		MyBase.DataFormInstanceId = New Guid("e09beb61-3e7b-4e60-8f77-07b395eabbce")
		MyBase.RecordType = "Letterscanner"
		MyBase.FORMHEADER.Value = "Sponsor Mailing 2014 Letter Scanner"
		MyBase.UserInterfaceUrl = "browser/htmlforms/custom/SponsorMailing2014LetterScannerAddDataForm.html"
	...
	<System.CodeDom.Compiler.GeneratedCodeAttribute("BBUIModelLibrary", "2.93.2034.0")> _
	Public ReadOnly Property [BARCODEELEMENTS]() As Global.Blackbaud.AppFx.UIModeling.Core.CollectionField(Of SponsorMailing2014LetterScannerAddDataFormBARCODEELEMENTSUIModel)
		Get
