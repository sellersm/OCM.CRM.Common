...
Public Class SponsorMailing2014LetterScannerAddDataFormUIModel
	...
	'*******************************************************
	'  NEED TO FINISH:
	'   - implement the @FinderNumber parameter & variable
	'*******************************************************
	...
	' Not using barcode length since findernumber can be variable length, will have to search for it and the child lookup id
	'Private _barCodeLength As Integer = _sponsorIdLength + _childIdLength + _letterTypeLength ' + _interactionIdLength




	Private Sub SponsorMailing2014LetterScannerAddDataFormUIModel_Loaded(ByVal sender As Object, ByVal e As Blackbaud.AppFx.UIModeling.Core.LoadedEventArgs) Handles Me.Loaded
	...
	Private Sub SponsorMailing2014LetterScannerAddDataFormUIModel_BeginValidate(ByVal sender As Object, ByVal e As Blackbaud.AppFx.UIModeling.Core.BeginValidateEventArgs) Handles Me.BeginValidate
		...
		Dim element As SponsorMailing2014LetterScannerAddDataFormBARCODEELEMENTSUIModel = New SponsorMailing2014LetterScannerAddDataFormBARCODEELEMENTSUIModel()
	...
	Private Sub ProcessBarCode()
		...
		Using conn As SqlClient.SqlConnection = Me.GetRequestContext().OpenAppDBConnection()
			...
			cmd.Connection = conn
			cmd.CommandText = "dbo.USR_USP_SPONSORMAILING2014_LETTERSCANNER"
