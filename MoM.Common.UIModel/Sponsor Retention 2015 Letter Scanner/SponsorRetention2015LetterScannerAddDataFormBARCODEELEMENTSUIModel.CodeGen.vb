...
'------------------------------------------------------------------------------
''' <summary>
''' Represents the UI model for the 'SponsorRetention2015LetterScannerAddDataFormBARCODEELEMENTS' data form
''' </summary>
Partial Public Class [SponsorRetention2015LetterScannerAddDataFormBARCODEELEMENTSUIModel]
