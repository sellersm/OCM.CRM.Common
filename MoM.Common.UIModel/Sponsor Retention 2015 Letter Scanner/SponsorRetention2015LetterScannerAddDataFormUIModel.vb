...
Public Class SponsorRetention2015LetterScannerAddDataFormUIModel
	...
	Private Sub SponsorMailing2014LetterScannerAddDataFormUIModel_BeginValidate(ByVal sender As Object, ByVal e As Blackbaud.AppFx.UIModeling.Core.BeginValidateEventArgs) Handles Me.BeginValidate
		...
		Dim element As SponsorRetention2015LetterScannerAddDataFormBARCODEELEMENTSUIModel = New SponsorRetention2015LetterScannerAddDataFormBARCODEELEMENTSUIModel()
