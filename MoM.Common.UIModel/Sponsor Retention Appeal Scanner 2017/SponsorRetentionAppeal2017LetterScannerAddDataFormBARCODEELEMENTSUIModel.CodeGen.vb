...
'------------------------------------------------------------------------------
''' <summary>
''' Represents the UI model for the 'SponsorRetentionAppeal2017LetterScannerAddDataFormBARCODEELEMENTS' data form
''' </summary>
Partial Public Class [SponsorRetentionAppeal2017LetterScannerAddDataFormBARCODEELEMENTSUIModel]
