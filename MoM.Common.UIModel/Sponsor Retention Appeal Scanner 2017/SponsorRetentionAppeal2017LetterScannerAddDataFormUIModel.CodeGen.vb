...
'------------------------------------------------------------------------------
''' <summary>
''' Represents the UI model for the 'Sponsor Retention Appeal 2017 Letter Scanner Add Data Form' data form
''' </summary>
<Global.Blackbaud.AppFx.UIModeling.Core.DataFormUIModelMetadata(Global.Blackbaud.AppFx.UIModeling.Core.DataFormMode.Add, "59600bb2-ee1f-4956-b8e5-8f0d7f6ec220", "fcd94761-fbab-4204-85f6-8d58cf2dfb1b", "Letterscanner")> _
Partial Public Class [SponsorRetentionAppeal2017LetterScannerAddDataFormUIModel]
...
#End Region
	...
	Private WithEvents _barcodeelements As Global.Blackbaud.AppFx.UIModeling.Core.CollectionField(Of SponsorRetentionAppeal2017LetterScannerAddDataFormBARCODEELEMENTSUIModel)
	...
	Public Sub New()
		...
		_barcodeelements = New Global.Blackbaud.AppFx.UIModeling.Core.CollectionField(Of SponsorRetentionAppeal2017LetterScannerAddDataFormBARCODEELEMENTSUIModel)
		...
		MyBase.DataFormTemplateId = New Guid("59600bb2-ee1f-4956-b8e5-8f0d7f6ec220")
		MyBase.DataFormInstanceId = New Guid("fcd94761-fbab-4204-85f6-8d58cf2dfb1b")
		MyBase.RecordType = "Letterscanner"
		MyBase.FORMHEADER.Value = "Scan 2017 Sponsor Retention Appeal"
		MyBase.UserInterfaceUrl = "browser/htmlforms/custom/SponsorRetentionAppeal2017LetterScannerAddDataForm.html"
	...
	<System.CodeDom.Compiler.GeneratedCodeAttribute("BBUIModelLibrary", "2.93.2034.0")> _
	Public ReadOnly Property [BARCODEELEMENTS]() As Global.Blackbaud.AppFx.UIModeling.Core.CollectionField(Of SponsorRetentionAppeal2017LetterScannerAddDataFormBARCODEELEMENTSUIModel)
		Get
