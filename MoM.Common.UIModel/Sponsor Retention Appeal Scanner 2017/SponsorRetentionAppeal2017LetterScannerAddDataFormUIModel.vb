...
Public Class SponsorRetentionAppeal2017LetterScannerAddDataFormUIModel
	...
	Private Sub SponsorRetentionAppeal2017LetterScannerAddDataFormUIModel_Loaded(ByVal sender As Object, ByVal e As Blackbaud.AppFx.UIModeling.Core.LoadedEventArgs) Handles Me.Loaded
	...
	Private Sub SponsorRetentionAppeal2017LetterScannerAddDataFormUIModel_BeginValidate(ByVal sender As Object, ByVal e As Blackbaud.AppFx.UIModeling.Core.BeginValidateEventArgs) Handles Me.BeginValidate
		...
		Dim element As SponsorRetentionAppeal2017LetterScannerAddDataFormBARCODEELEMENTSUIModel = New SponsorRetentionAppeal2017LetterScannerAddDataFormBARCODEELEMENTSUIModel()
	...
	Private Sub ProcessBarCode()
		...
		Using conn As SqlClient.SqlConnection = Me.GetRequestContext().OpenAppDBConnection()
			...
			cmd.Connection = conn
			cmd.CommandText = "dbo.USR_USP_SPONSORRETENTION_APPEAL_2017_LETTERSCANNER"
