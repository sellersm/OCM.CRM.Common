...
'------------------------------------------------------------------------------
''' <summary>
''' Represents the UI model for the 'SponsorBarCodeAddDataFormBARCODEELEMENTS' data form
''' </summary>
Partial Public Class [SponsorBarCodeAddDataFormBARCODEELEMENTSUIModel]
